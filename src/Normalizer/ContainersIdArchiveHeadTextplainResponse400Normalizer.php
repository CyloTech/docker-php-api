...
class ContainersIdArchiveHeadTextplainResponse400Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    use CheckArray;
    ...
    {
        return \is_object($data) && 'Docker\\API\\Model\\ContainersIdArchiveHeadTextplainResponse400' === \get_class($data);
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Docker\API\Model\ContainersIdArchiveHeadTextplainResponse400();
